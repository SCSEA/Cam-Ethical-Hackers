...
print('\n')
print(green+' |   ‌®®®     ®®®                    ')
print(' |   ®®®     ®®®      https://github.com/SCSEA/Cam-Ethical-Hackers         ')
print(' |   ®®®     ®®®                ')
print(' |   ®®®®®®®®®®®       ')
print(' |   ®®®     ®®®          ')
print(' |   ®®®     ®®®    ')
print(' |   ®®®     ®®®    ')
print('\n')
print(green+'%37s' % '   |Devoloped By : Yousuf Shafi')
print(red+'~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~')
print(blue+'Youtube Chanel: Programmer86867')
print(blue+'Telegarm Programmerboy1')
print(red+'~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~')
